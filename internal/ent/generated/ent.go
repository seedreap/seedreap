...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			appjob.Table:          appjob.ValidColumn,
			downloadclient.Table:  downloadclient.ValidColumn,
			downloadfile.Table:    downloadfile.ValidColumn,
			downloadjob.Table:     downloadjob.ValidColumn,
			event.Table:           event.ValidColumn,
			movejob.Table:         movejob.ValidColumn,
			syncfile.Table:        syncfile.ValidColumn,
			syncjob.Table:         syncjob.ValidColumn,
			trackeddownload.Table: trackeddownload.ValidColumn,
		})
	})
