...
func (_q *AppQuery) FirstID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (_q *AppQuery) FirstIDX(ctx context.Context) ulid.ULID {
...
func (_q *AppQuery) OnlyID(ctx context.Context) (id ulid.ULID, err error) {
	var ids []ulid.ULID
...
func (_q *AppQuery) OnlyIDX(ctx context.Context) ulid.ULID {
...
func (_q *AppQuery) IDs(ctx context.Context) (ids []ulid.ULID, err error) {
...
func (_q *AppQuery) IDsX(ctx context.Context) []ulid.ULID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
